...
from linebot.models import ConfirmTemplate,CarouselColumn,CarouselTemplate,ImageCarouselTemplate, ImageCarouselColumn,ImagemapSendMessage,BaseSize,MessageImagemapAction,ImagemapArea, URIImagemapAction
